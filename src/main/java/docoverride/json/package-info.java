 ...
 *
 * A JSON object is basically just a map which has string keys and values can be
 * of one of the JSON supported types (string, number, boolean).
 *
 ...
 *
 * [source,java] ---- {@link docoverride.json.Examples#example0_1} ----
 *
 * ==== Putting entries into a JSON object
 *
 * Use the {@link io.vertx.core.json.JsonObject#put} methods to put values into
 * the JSON object.
 *
 * The method invocations can be chained because of the fluent API:
 *
 * [source,java] ---- {@link docoverride.json.Examples#example1} ----
 *
 * ==== Getting values from a JSON object
 *
 * You get values from a JSON object using the {@code getXXX} methods, for
 * example:
 *
 * [source,java] ---- {@link docoverride.json.Examples#example2} ----
 *
 * ==== Encoding the JSON object to a String
 *
 * You use {@link io.vertx.core.json.JsonObject#encode} to encode the object to
 * a String form.
 *
 * === JSON arrays
 *
 ...
 *
 * [source,java] ---- {@link docoverride.json.Examples#example0_2} ----
 *
 * ==== Adding entries into a JSON array
 *
 * You add entries to a JSON array using the
 * {@link io.vertx.core.json.JsonArray#add} methods.
 *
 * [source,java] ---- {@link docoverride.json.Examples#example3} ----
 *
 * ==== Getting values from a JSON array
 *
 * You get values from a JSON array using the {@code getXXX} methods, for
 * example:
 *
 * [source,java] ---- {@link docoverride.json.Examples#example4} ----
 *
 * ==== Encoding the JSON array to a String
 *
 * You use {@link io.vertx.core.json.JsonArray#encode} to encode the array to a
 * String form.
 *
 *
 */
