 ...
 * <p>
 * It's useful in Vert.x to represent things in Vert.x like HTTP headers and
 * HTTP parameters which allow multiple values for keys.
 *
...
public interface MultiMap extends Iterable<Map.Entry<String, String>> {
  ...
  /**
   * Create a multi-map implementation with case insensitive keys, for instance
   * it can be used to hold some HTTP headers.
   *
   ...
   * @return A immutable {@link java.util.List} of values which will be empty if
   * no values are found
   */
  List<String> getAll(String name);

  /**
   * Like {@link #getAll(String)} but accepting a {@code CharSequence} as a
   * parameter
   */
  @GenIgnore
   ...
   *
   * @return A immutable {@link java.util.List} of the name-value entries, which
   * will be empty if no pairs are found
   */
  @GenIgnore
  ...
  /**
   * Like {@link #contains(String)} but accepting a {@code CharSequence} as a
   * parameter
   */
  @GenIgnore
  ...
  /**
   * Like {@link #add(String, String)} but accepting {@code CharSequence} as
   * parameters
   */
  @GenIgnore
  ...
  /**
   * Like {@link #add(String, Iterable)} but accepting {@code CharSequence} as
   * parameters
   */
  @GenIgnore
  ...
  /**
   * Like {@link #set(String, String)} but accepting {@code CharSequence} as
   * parameters
   */
  @GenIgnore
  ...
  /**
   * Like {@link #set(String, Iterable)} but accepting {@code CharSequence} as
   * parameters
   */
  @GenIgnore
  ...
  /**
   * Like {@link #remove(String)} but accepting {@code CharSequence} as
   * parameters
   */
  @GenIgnore
