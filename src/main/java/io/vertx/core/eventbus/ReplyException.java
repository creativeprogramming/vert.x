 ...
 * <p>
 * If a message was sent specifying a reply handler and the message delivery
 * fails, a failure will be provided to the reply handler and the cause of the
 * failure will be an instance of this.
 *
