...
public class Arguments {
   ...
   * {@link IllegalArgumentException} if it is {@code false}.
   *
  ...
  /**
   * Checks that the specified number is within the specified minimum and
   * maximum range (inclusively) and throws a customized
