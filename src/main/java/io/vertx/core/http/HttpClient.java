 ...
 * <p>
 * It allows you to make requests to HTTP servers, and a single client can make
 ...
 * {@link io.vertx.core.http.HttpClientOptions} (default is true). In this case
 * connections will be pooled and re-used if there are pending HTTP requests
 * waiting to get a connection, otherwise they will be closed.
 * <p>
 * This gives the benefits of keep alive when the client is loaded but means we
 * don't keep connections hanging around unnecessarily when there would be no
 * benefits anyway.
 * <p>
 * The client also supports pipe-lining of requests. Pipe-lining means another
 * request is sent on the same connection before the response from the preceding
 * one has returned. Pipe-lining is not appropriate for all requests.
 * <p>
 * To enable pipe-lining, it must be enabled on the
 * {@link io.vertx.core.http.HttpClientOptions} (default is false).
 * <p>
 * When pipe-lining is enabled the connection will be automatically closed when
 * all in-flight responses have returned and there are no outstanding pending
 * requests to write.
 * <p>
...
public interface HttpClient extends Measured {
  ...
  /**
   * Create an HTTP request to send to the server at the specified host and
   * port, specifying a response handler to receive the response
   *
   * @param method the HTTP method
   * @param port the port
   * @param host the host
  ...
  /**
   * Create an HTTP request to send to the server at the specified host and
   * default port, specifying a response handler to receive the response
   *
   * @param method the HTTP method
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Sends an HTTP GET request to the server at the specified host and port,
   * specifying a response handler to receive the response
   *
   * @param port the port
   * @param host the host
  ...
  /**
   * Sends an HTTP GET request to the server at the specified host and default
   * port, specifying a response handler to receive the response
   *
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Sends an HTTP GET request to the server at the default host and port,
   * specifying a response handler to receive the response
   *
   * @param requestURI the relative URI
   * @param responseHandler the response handler
  ...
  /**
   * Sends an HTTP HEAD request to the server at the specified host and port,
   * specifying a response handler to receive the response
   *
   * @param port the port
   * @param host the host
  ...
  /**
   * Sends an HTTP HEAD request to the server at the specified host and default
   * port, specifying a response handler to receive the response
   *
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Sends an HTTP HEAD request to the server at the default host and port,
   * specifying a response handler to receive the response
   *
   * @param requestURI the relative URI
   * @param responseHandler the response handler
  ...
  /**
   * Create an HTTP OPTIONS request to send to the server at the specified host
   * and port.
   *
   * @param port the port
   * @param host the host
  ...
  /**
   * Create an HTTP OPTIONS request to send to the server at the specified host
   * and port, specifying a response handler to receive the response
   *
   * @param port the port
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Create an HTTP OPTIONS request to send to the server at the specified host
   * and default port, specifying a response handler to receive the response
   *
   * @param host the host
   * @param requestURI the relative URI
   * @param responseHandler the response handler
  ...
  /**
   * Create an HTTP OPTIONS request to send to the server at the default host
   * and port.
   *
   * @param requestURI the relative URI
   * @return an HTTP client request object
  ...
  /**
   * Sends an HTTP OPTIONS request to the server at the specified host and port,
   * specifying a response handler to receive the response
   *
   * @param port the port
   * @param host the host
  ...
  /**
   * Sends an HTTP OPTIONS request to the server at the specified host and
   * default port, specifying a response handler to receive the response
   *
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Sends an HTTP OPTIONS request to the server at the default host and port,
   * specifying a response handler to receive the response
   *
   * @param requestURI the relative URI
   * @param responseHandler the response handler
  ...
  /**
   * Create an HTTP DELETE request to send to the server at the specified host
   * and port.
   *
   * @param port the port
   * @param host the host
   ...
   * @param host the host
   * @param requestURI the relative URI
   * @param wsConnect handler that will be called with the websocket when
   * connected
   * @return a reference to this, so the API can be used fluently
   */
  @Fluent
   ...
   * @param wsConnect handler that will be called with the websocket when
   * connected
   * @param failureHandler handler that will be called if websocket connection
   * fails
   * @return a reference to this, so the API can be used fluently
   */
  @Fluent
  ...
  /**
   * Connect a WebSocket to the specified port, host and relative request URI,
   * and with the specified headers
   *
   * @param port the port
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Connect a WebSocket to the specified host,relative request UR, and default
   * port and with the specified headers
   *
   * @param host the host
   * @param requestURI the relative URI
   * @param headers the headers
  ...
  /**
   * Connect a WebSocket to the specified port, host and relative request URI,
   * with the specified headers and using the specified version of WebSockets
   *
   * @param port the port
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Connect a WebSocket to the specified host, relative request URI and default
   * port with the specified headers and using the specified version of
   * WebSockets
   *
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Connect a WebSocket to the specified port, host and relative request URI,
   * with the specified headers, using the specified version of WebSockets, and
   * the specified websocket sub protocols
   *
   * @param port the port
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Connect a WebSocket to the specified host, relative request URI and default
   * port, with the specified headers, using the specified version of
   * WebSockets, and the specified websocket sub protocols
   *
   * @param host the host
   * @param requestURI the relative URI
   * @param headers the headers
  ...
  /**
   * Connect a WebSocket at the relative request URI using the default host and
   * port
   *
   * @param requestURI the relative URI
   * @param wsConnect handler that will be called with the websocket when
  ...
  /**
   * Connect a WebSocket at the relative request URI using the default host and
   * port and the specified headers
   *
   * @param requestURI the relative URI
   * @param headers the headers
   * @param wsConnect handler that will be called with the websocket when
  ...
  /**
   * Connect a WebSocket at the relative request URI using the default host and
   * port, the specified headers and the specified version of WebSockets
   *
   * @param requestURI the relative URI
   * @param headers the headers
   * @param version the websocket version
  ...
  /**
   * Connect a WebSocket at the relative request URI using the default host and
   * port, the specified headers, the specified version of WebSockets and the
  ...
  /**
   * Create a WebSocket stream to the specified port, host and relative request
   * URI
   *
   * @param port the port
   * @param host the host
  ...
  /**
   * Create a WebSocket stream to the specified host, relative request URI and
   * default port
   *
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Create a WebSocket stream to the specified port, host and relative request
   * URI, and with the specified headers
   *
   * @param port the port
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Create a WebSocket stream to the specified host, relative request URI and
   * default port and with the specified headers
   *
   * @param host the host
   * @param requestURI the relative URI
   * @param headers the headers
  ...
  /**
   * Create a WebSocket stream to the specified port, host and relative request
   * URI, with the specified headers and using the specified version of
   * WebSockets
   *
   * @param port the port
   * @param host the host
  ...
  /**
   * Create a WebSocket stream to the specified host, relative request URI and
   * default port and with the specified headers and using the specified version
   * of WebSockets
   *
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Create a WebSocket stream to the specified port, host and relative request
   * URI, with the specified headers, using the specified version of WebSockets,
  ...
  /**
   * Create a WebSocket stream to the specified host, relative request URI and
   * default port, with the specified headers, using the specified version of
   * WebSockets, and the specified websocket sub protocols
   *
   * @param host the host
   * @param requestURI the relative URI
  ...
  /**
   * Create a WebSocket stream at the relative request URI using the default
   * host and port and the specified headers
   *
   * @param requestURI the relative URI
   * @return a reference to this, so the API can be used fluently
   */
  ...
  /**
   * Create a WebSocket stream at the relative request URI using the default
   * host and port, the specified headers and the specified version of
   * WebSockets
   *
   * @param requestURI the relative URI
   * @param headers the headers
  ...
  /**
   * Create a WebSocket stream at the relative request URI using the default
   * host and port, the specified headers, the specified version of WebSockets
   * and the specified sub protocols
   *
   * @param requestURI the relative URI
   * @param headers the headers
   * @param version the websocket version
