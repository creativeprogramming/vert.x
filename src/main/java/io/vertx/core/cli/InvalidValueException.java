...
public class InvalidValueException extends CLIException {
  ...
  /**
   * Creates a new instance of {@link InvalidValueException} for the given
   * option and the given value. This constructor is used when the option
   * receives a value while it does not accept another value.
   *
  ...
  /**
   * Creates a new instance of {@link InvalidValueException} for the given
   * argument and the given value. This constructor is used when the argument
   * receives a value that cannot be "converted" to the desired type.
   *
  ...
  /**
   * Creates a new instance of {@link InvalidValueException} for the given
   * option and the given value. This constructor is used when the options
   * receives a value that cannot be "converted" to the desired type.
   *
   * @param option the option
   * @param value the value
