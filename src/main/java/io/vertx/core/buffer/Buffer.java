 ...
 * <p>
 * A buffer is a sequence of zero or more bytes that can read from or written to
 * and which expands automatically as necessary to accommodate any bytes written
 * to it. You can perhaps think of a buffer as smart byte array.
 * <p>
...
public interface Buffer extends ClusterSerializable {
  ...
  /**
   * Create a new buffer from a string. The string will be UTF-8 encoded into
   * the buffer.
   *
   ...
   * <i>Note that</i> the returned buffer is backed by given Netty ByteBuf, so
   * changes in the returned buffer are reflected in given Netty ByteBuf, and
   * vice-versa.
   * </p>
   * <p>
  ...
  /**
   * Returns a {@code String} representation of the Buffer with the {@code UTF-8
   * }encoding
   */
  String toString();
   ...
   * {@code 0} or {@code pos + 1} is greater than the length of the Buffer.
   */
  byte getByte(int pos);

  /**
   * Returns the unsigned {@code byte} at position {@code pos} in the Buffer, as
   * a {@code short}.
   *
   * @throws IndexOutOfBoundsException if the specified {@code pos} is less than
   * {@code 0} or {@code pos + 1} is greater than the length of the Buffer.
   ...
   *
   * @throws IndexOutOfBoundsException if the specified {@code pos} is less than
   * {@code 0} or {@code pos + 4} is greater than the length of the Buffer.
   */
  int getInt(int pos);

  /**
   * Gets a 32-bit integer at the specified absolute {@code index} in this
   * buffer with Little Endian Byte Order.
   *
   * @throws IndexOutOfBoundsException if the specified {@code index} is less
   * than {@code 0} or {@code index + 4} is greater than {@code this.capacity}
   */
  int getIntLE(int pos);

  /**
   * Returns the unsigned {@code int} at position {@code pos} in the Buffer, as
   * a {@code long}.
   *
   * @throws IndexOutOfBoundsException if the specified {@code pos} is less than
   * {@code 0} or {@code pos + 4} is greater than the length of the Buffer.
  ...
  /**
   * Returns the unsigned {@code int} at position {@code pos} in the Buffer, as
   * a {@code long} in Little Endian Byte Order.
   *
   * @throws IndexOutOfBoundsException if the specified {@code pos} is less than
   * {@code 0} or {@code pos + 4} is greater than the length of the Buffer.
   */
   ...
   *
   * @throws IndexOutOfBoundsException if the specified {@code pos} is less than
   * {@code 0} or {@code pos + 8} is greater than the length of the Buffer.
   */
   ...
   *
   * @throws IndexOutOfBoundsException if the specified {@code index} is less
   * than {@code 0} or {@code index + 8} is greater than the length of the
   * Buffer.
   */
   ...
   *
   * @throws IndexOutOfBoundsException if the specified {@code pos} is less than
   * {@code 0} or {@code pos + 2} is greater than the length of the Buffer.
   */
   ...
   *
   * @throws IndexOutOfBoundsException if the specified {@code index} is less
   * than {@code 0} or {@code index + 2} is greater than the length of the
   * Buffer.
   */
  short getShortLE(int pos);

  /**
   * Returns the unsigned {@code short} at position {@code pos} in the Buffer,
   * as an {@code int}.
   *
   * @throws IndexOutOfBoundsException if the specified {@code pos} is less than
   * {@code 0} or {@code pos + 2} is greater than the length of the Buffer.
   ...
   *
   * @throws IndexOutOfBoundsException if the specified {@code index} is less
   * than {@code 0} or {@code index + 3} is greater than the length of the
   * Buffer.
   */
   ...
   * position {@code start} and ending at position {@code end - 1} interpreted
   ...
   * Returns a copy of a sub-sequence the Buffer as a {@code String} starting at
   * position {@code start} and ending at position {@code end - 1} interpreted
   * as a String in UTF-8 encoding
   */
  String getString(int start, int end);

  /**
   * Appends the specified {@code Buffer} to the end of this Buffer. The buffer
   * will expand as necessary to accommodate any bytes written.<p>
   ...
   * {@code len} to the end of this Buffer. The buffer will expand as necessary
   ...
   * Buffer, starting at the given offset. The buffer will expand as necessary
   * to accommodate any bytes written.<p>
   * Returns a reference to {@code this} so multiple operations can be appended
   * together.
   */
   ...
   * buffer will expand as necessary to accommodate any bytes written.<p>
   * Returns a reference to {@code this} so multiple operations can be appended
   * together.
   */
  @Fluent
   ...
   * Little Endian Byte Order. The buffer will expand as necessary to
   * accommodate any bytes written.<p>
   * Returns a reference to {@code this} so multiple operations can be appended
   * together.
   */
  @Fluent
  ...
  /**
   * Appends the specified 24bit {@code int} to the end of the Buffer. The
   * buffer will expand as necessary to accommodate any bytes written.<p>
   * Returns a reference to {@code this} so multiple operations can be appended
   * together.
   */
  ...
  /**
   * Appends the specified {@code long} to the end of the Buffer. The buffer
   * will expand as necessary to accommodate any bytes written.<p>
   * Returns a reference to {@code this} so multiple operations can be appended
   * together.
   */
  ...
  /**
   * Appends the specified {@code short} to the end of the Buffer.The buffer
   * will expand as necessary to accommodate any bytes written.<p>
   * Returns a reference to {@code this} so multiple operations can be appended
   * together.
   */
  ...
  /**
   * Appends the specified unsigned {@code short} to the end of the Buffer in
   * the Little Endian Byte Order.The buffer will expand as necessary to
   * accommodate any bytes written.<p>
   * Returns a reference to {@code this} so multiple operations can be appended
   * together.
   */
  ...
  /**
   * Appends the specified {@code float} to the end of the Buffer. The buffer
   * will expand as necessary to accommodate any bytes written.<p>
   * Returns a reference to {@code this} so multiple operations can be appended
   * together.
   */
  ...
  /**
   * Appends the specified {@code String str} to the end of the Buffer with
   * UTF-8 encoding.<p>
   * The buffer will expand as necessary to accommodate any bytes written.<p>
   * Returns a reference to {@code this} so multiple operations can be appended
   * together<p>
  ...
  /**
   * Sets the {@code int} at position {@code pos} in the Buffer to the value
   * {@code i} in the Little Endian Byte Order.<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  @Fluent
  ...
  /**
   * Sets the unsigned {@code int} at position {@code pos} in the Buffer to the
   * value {@code i} in the Little Endian Byte Order.<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  @Fluent
  ...
  /**
   * Sets the 24bit {@code int} at position {@code pos} in the Buffer to the
   * value {@code i}
   * .<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  ...
  /**
   * Sets the {@code long} at position {@code pos} in the Buffer to the value
   * {@code l} in the Little Endian Byte Order.<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  @Fluent
  ...
  /**
   * Sets the {@code short} at position {@code pos} in the Buffer to the value
   * {@code s} in the Little Endian Byte Order.<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  @Fluent
  ...
  /**
   * Sets the unsigned {@code short} at position {@code pos} in the Buffer to
   * the value {@code s}
   * .<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  ...
  /**
   * Sets the unsigned {@code short} at position {@code pos} in the Buffer to
   * the value {@code s} in the Little Endian Byte Order.<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  @Fluent
  ...
  /**
   * Sets the bytes at position {@code pos} in the Buffer to the bytes
   * represented by the {@code Buffer b}
   * .<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  @Fluent
  ...
  /**
   * Sets the bytes at position {@code pos} in the Buffer to the bytes
   * represented by the {@code Buffer b} on the given {@code offset} and
   * {@code len}
   * .<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  ...
  /**
   * Sets the bytes at position {@code pos} in the Buffer to the bytes
   * represented by the {@code ByteBuffer b}
   * .<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  @GenIgnore
  ...
  /**
   * Sets the bytes at position {@code pos} in the Buffer to the bytes
   * represented by the {@code byte[] b}
   * .<p>
   * The buffer will expand as necessary to accommodate any value written.
   */
  @GenIgnore
  ...
  /**
   * Returns a slice of this buffer. Modifying the content of the returned
   * buffer or this buffer affects each other's content while they maintain
   * separate indexes and marks.
   */
  Buffer slice();
