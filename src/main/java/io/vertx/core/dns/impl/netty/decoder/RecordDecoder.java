 ...
 * example, an {@link AddressDecoder} will return a
...
public interface RecordDecoder<T> {
   ...
   * {@link io.vertx.core.dns.impl.netty.decoder.RecordDecoder} after decoding a
   * resource record when given a DNS response packet.
   *
