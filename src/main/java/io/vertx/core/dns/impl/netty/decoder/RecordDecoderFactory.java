...
public final class RecordDecoderFactory {
  ...
  /**
   * Returns the active
   * {@link io.vertx.core.dns.impl.netty.decoder.RecordDecoderFactory}, which is
   * the same as the default factory if it has not been changed by the user.
   */
  ...
  /**
   * Sets the active
   * {@link io.vertx.core.dns.impl.netty.decoder.RecordDecoderFactory} to be
   * used for decoding resource records.
   *
   * @param factory the
   * {@link io.vertx.core.dns.impl.netty.decoder.RecordDecoderFactory} to use
   */
  ...
  /**
   * Creates a new
   * {@link io.vertx.core.dns.impl.netty.decoder.RecordDecoderFactory} only
   * using the default decoders.
   */
  ...
  /**
   * Creates a new
   * {@link io.vertx.core.dns.impl.netty.decoder.RecordDecoderFactory} using the
   * default decoders and custom decoders (custom decoders override defaults).
   *
   * @param customDecoders user supplied resource record decoders, mapping the
   * resource record's type to the decoder
   */
  ...
  /**
   * Creates a {@link io.vertx.core.dns.impl.netty.decoder.RecordDecoderFactory}
   * using either custom resource record decoders, default decoders, or both. If
   * a custom decoder has the same record type as a default decoder, the default
   * decoder is overriden.
   *
