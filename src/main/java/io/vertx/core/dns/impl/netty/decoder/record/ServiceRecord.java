...
public class ServiceRecord {
   ...
   * service, the protocol, and the name of the server being queried. The format
   * is {@code _service._protocol.hostname}, or for example
   * {@code _http._tcp.example.com}
   ...
   * event they have the same priority (greater weight means service is used
   * more often)
