...
public class AddressDecoder implements RecordDecoder<InetAddress> {
  ...
  /**
   * Returns an {@link java.net.InetAddress} containing a decoded address from
   * either an A or AAAA resource record.
   *
   * @param response the {@link io.vertx.core.dns.impl.netty.DnsResponse}
   * received that contained the resource record being decoded
