 ...
 * verticles from the command line. It is extensible as "commands" can be added
 * using the {@link io.vertx.core.spi.launcher.CommandFactory} SPI.
 * <p/>
 * E.g.
 * <p/>
...
public class Launcher extends VertxCommandLauncher implements VertxLifecycleHooks {
   ...
   *
   * @param deploymentOptions the current deployment options. Modify them to
