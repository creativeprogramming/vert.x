...
public class VertxTestBase extends AsyncTestBase {
  ...
  /**
   * @return create a blank new Vert.x instance with no options closed when tear
   * down executes.
   */
  protected Vertx vertx() {
    if (created == null) {
  ...
  /**
   * @return create a blank new Vert.x instance with @{@code options} closed
   * when tear down executes.
   */
  ...
  /**
   * Create a blank new clustered Vert.x instance with @{@code options} closed
   * when tear down executes.
   */
  ...
  /**
   * Create worker verticles for the current Vert.x and returns the list of
   * their contexts.
   *
